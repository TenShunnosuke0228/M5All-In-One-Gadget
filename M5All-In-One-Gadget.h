...
#define WBGT_T2DIGIT_Y_CRD 0   //熱中症モニタ画面の「温度の10の位の数字」画像のy座標
#define WBGT_T1DIGIT_X_CRD 153   //熱中症モニタ画面の「温度の1の位の数字」画像のx座標
#define WBGT_T1DIGIT_Y_CRD 0   //熱中症モニタ画面の「温度の1の位の数字」画像のy座標
#define WBGT_TDOT_X_CRD 186   //熱中症モニタ画面の「温度の.」画像のx座標
#define WBGT_TDOT_Y_CRD 0   //熱中症モニタ画面の「温度の.」画像のy座標
#define WBGT_T1DECIMAL_X_CRD 220   //熱中症モニタ画面の「温度の小数第一位の数字」画像のx座標
#define WBGT_T1DECIMAL_Y_CRD 0   //熱中症モニタ画面の「温度の小数第一位の数字」画像のy座標
#define WBGT_DEGREE_X_CRD 253   //熱中症モニタ画面の「℃」画像のx座標
#define WBGT_DEGREE_Y_CRD 0   //熱中症モニタ画面の「℃」画像のy座標
#define WBGT_H2DIGIT_X_CRD 120   //熱中症モニタ画面の「湿度の十の位の数字」画像のx座標
#define WBGT_H2DIGIT_Y_CRD 50   //熱中症モニタ画面の「湿度の十の位の数字」画像のy座標
#define WBGT_H1DIGIT_X_CRD 153   //熱中症モニタ画面の「湿度の一の位の数字」画像のx座標
#define WBGT_H1DIGIT_Y_CRD 50  // 熱中症モニタ画面の「湿度の一の位の数字」画像のy座標
#define WBGT_HDOT_X_CRD 186   //熱中症モニタ画面の「湿度の.」画像のx座標
#define WBGT_HDOT_Y_CRD 50   //熱中症モニタ画面の「湿度の.」画像のy座標
#define WBGT_H1DECIMAL_X_CRD 220   //熱中症モニタ画面の「湿度の小数第一位の数字」画像のx座標
#define WBGT_H1DECIMAL_Y_CRD 50   //熱中症モニタ画面の「湿度の小数第一位の数字」画像のy座標
#define WBGT_PERCENT_X_CRD 253   //熱中症モニタ画面の「%」画像のx座標
#define WBGT_PERCENT_Y_CRD 50   //熱中症モニタ画面の「%」画像のy座標
#define WBGT_NOTICE_X_CRD 0   //熱中症モニタ画面の「熱中症アラート」画像のx座標
#define WBGT_NOTICE_Y_CRD 100   //熱中症モニタ画面の「熱中症アラート」画像のy座標
#define WBGT_BACK_X_CRD 120   //熱中症モニタ画面の「戻るボタン」画像のx座標
#define WBGT_BACK_Y_CRD 200   //熱中症モニタ画面の「戻るボタン」画像のy座標
...
#define DATE_BACK_X_CRD 120                   //戻る
#define DATE_BACK_Y_CRD 200                   //戻る
